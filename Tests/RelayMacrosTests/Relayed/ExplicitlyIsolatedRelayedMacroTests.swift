//
//  ExplicitlyIsolatedRelayedMacroTests.swift
//  Relay
//
...
//
    ...
    internal final class ExplicitlyIsolatedRelayedMacroTests: XCTestCase {
        ...
        func testExpansion() {
            assertMacroExpansion(
                ...
                @CustomActor @Relayed(isolation: MainActor.self)
